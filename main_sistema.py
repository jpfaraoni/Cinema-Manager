from interface.cinema_interface import CinemaInterface  # Interface completa do gerente
from interface.cliente_interface import ClienteInterface  # Interface limitada para o cliente
